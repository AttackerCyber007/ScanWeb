...
print"\n";                    
print "\t+---------------------------+\n";
print "\t|  +<Attacker Web Finder>+  |\n";
print "\t|  +>BLACK_PHANTOM_CYBER<+  |\n";
print "\t|    >>5H311_1NJ3C706<<     |\n";
print "\t+---------------------------+\n";


print " Pindai Situs Web Anda Jembot\n\n Contohnya Babi: www.site.com \n\n-> ";
...
@path = ('wso_2.1_(web_shell_by_orb).php','WSO.php','inc.php','c99.php','psv.php','dz.php','w.php','wp-content/plugins/akismet/akismet.php','images/stories/w.php','BPC.php','shell.php','Attacker.php','cpn.php','Kamu.php','sql.php','mysql.php','config.php','configuration.php','madspot.php','Cgishell.pl','killer.php','changeall.php','2.php','Sh3ll.php','dz0.php','dam.php','log.php','dom.php','whmcs.php','r00t.php','a.phtml','sca.phtml','r0k.php','Kamu.phtml','egy.php','syrian_shell.php','xxx.php','settings.php','tmp.php','cyber.php','c99.php','r57.php','404.php','gaza.php','1.php','d4rk.php','index1.php','nkr.php','xd.php','M4r0c.php','Dz.php','sniper.php','ksa.php','v4team.php','offline.php','priv8.php','up.php','madspotshell.php','c100.php','sym.php','mini.php','tmp/cpn.php','tmp/w.php','tmp/r57.php','tmp/king.php','tmp/sok.php','tmp/ss.php','tmp/ransomware.php','tmp/dz.php','tmp/r1z.php','tmp/whmcs.php','tmp/root.php','tmp/r00t.php','templates/beez/index.php','templates/beez/beez.php','templates/rhuk_milkyway/index.php','tmp/uploads.php','tmp/upload.php','tmp/sa.php','sa.php','readme.php','tmp/readme.php','wp.zip'.'wp-content/plugins/disqus-comment-system/disqus.php',
...
print "Webshell encontrada : $url\n";
}else{
print "No encontrada : $myshell\n";
}
}
